    ...
    public static class ChromosomeRepository
    {
        public static IChromosomeRepository WithTestData()
        {
            return new ChromosomeRepositoryImpl(
                ...
                //new []
                //{
                //    ChromosomeBuildInfo.GenInfo(Guid.NewGuid(), 123, 700, symbolSetInit).ToChromosomeUint<int>(),
                //    ChromosomeBuildInfo.GenInfo(Guid.NewGuid(), 124, 700, symbolSetInit).ToChromosomeUint<int>(),
                //    ChromosomeBuildInfo.GenInfo(Guid.NewGuid(), 125, 700, symbolSetInit).ToChromosomeUint<int>(),
                //    ChromosomeBuildInfo.GenInfo(Guid.NewGuid(), 126, 700, symbolSetInit).ToChromosomeUint<int>(),
                //    ChromosomeBuildInfo.GenInfo(Guid.NewGuid(), 127, 700, symbolSetInit).ToChromosomeUint<int>(),
                //    ChromosomeBuildInfo.GenInfo(Guid.NewGuid(), 128, 700, symbolSetInit).ToChromosomeUint<int>()                
                //}
                );
        }
    }
